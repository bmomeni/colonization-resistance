...
infile = 'CRC_Nif20_Dp_ExMTC_ABE_fp20_fpI10_CSD1e+04_DilTh1e+07_ExtTh0.1_Ksat10000_ri20_riI20_r0m10_r0Inv15_bt10_at50_Nc20_Nm10_qp30_qc30_qpi30_qci30_Nr20_Ns1000_rndseed6130.mat';
load(infile)
fpcnt = 2;
CommCntC(fpcnt) = sum(NE0DC(2,:)>1);
InvCommAD = (InvEffAD1(1:Nif-1,NE0DC(1,:)>1)>=0.95);
...
infile = 'CRC_Nif20_Dp_ExMTC_ABE_fp30_fpI10_CSD1e+04_DilTh1e+07_ExtTh0.1_Ksat10000_ri20_riI20_r0m10_r0Inv15_bt10_at50_Nc20_Nm10_qp30_qc30_qpi30_qci30_Nr20_Ns1000_rndseed6130.mat';
load(infile)
fpcnt = 3;
CommCntC(fpcnt) = sum(NE0DC(2,:)>1);
InvCommAD = (InvEffAD1(1:Nif-1,NE0DC(1,:)>1)>=0.95);
...
infile = 'CRC_Nif20_Dp_ExMTC_ABE_fp40_fpI10_CSD1e+04_DilTh1e+07_ExtTh0.1_Ksat10000_ri20_riI20_r0m10_r0Inv15_bt10_at50_Nc20_Nm10_qp30_qc30_qpi30_qci30_Nr20_Ns1000_rndseed6130.mat';
load(infile)
fpcnt = 4;
CommCntC(fpcnt) = sum(NE0DC(2,:)>1);
InvCommAD = (InvEffAD1(1:Nif-1,NE0DC(1,:)>1)>=0.95);
